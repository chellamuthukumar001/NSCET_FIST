    ...
    switch (role) {
      case 'FACULTY':
        return [
          ...
          {
            groupTitle: 'Performance & Tools',
            items: [
              { label: 'Class Analytics', path: '/faculty/analytics', icon: TrendingUp },
              { label: 'Faculty Copilot', path: '/faculty/assistant', icon: Sparkles, badge: 'AI' },
            ]
          }
        ];
      case 'HOD':
        ...
        return [
          {
            ...
            items: [
              ...
              { label: '10 Course Modules', path: '/student/courses', icon: GraduationCap, badge: '10 AU' },
              { label: 'YouTube Video Hub', path: '/student/videos', icon: Video, badge: 'Sync' },
          ...
          },
          {
            ...
            items: [
              { label: 'Certificates', path: '/student/certificates', icon: Award, badge: 'Verified' },
              { label: 'AI Practice Quiz', path: '/student/quiz', icon: Sparkles },
          ...
          {
            groupTitle: 'Intelligence & Account',
            items: [
              { label: 'CampusIQ Copilot', path: '/student/assistant', icon: Bot, badge: '⌘K' },
              {
                label: 'Notifications',
